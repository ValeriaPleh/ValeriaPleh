...
### О себе
Junior аналитик данных с техническим образованием и инженерным бэкграундом.<br>
Имею опыт аналитической и расчетной работы, анализа параметров и выбора оптимальных решений.<br>
